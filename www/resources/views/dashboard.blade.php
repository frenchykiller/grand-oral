...
@section('content')
    <div class="row">
        <div class="col-6">
            <x-boilerplate::infobox color="warning" icon="fas fa-exclamation-triangle" text="<a href='/creation-et-modification-d-aggregation-de-theme' target='_blank'>Guide pour la création et la mise à jour des pages d'aggrégat de thème.</a>" />
        </div>
        <div class="col-6"></div>
        <div class="col-6">
            <x-boilerplate::card>
